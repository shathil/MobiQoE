...
public class Session {
    ...
    private FlowMetaData flow = new FlowMetaData();

	//TODO: Hoque, check how to add Application name can be part of the session
	private String appName ="";

	//TODO: Hoque, check how to add protocol type (TCP/UDP) part of the session
	private String protocolType = "";

	//TODO: Hoque, check how to add content type (TCP/UDP) part of the session
	private int contentType = 4;

    //TODO: Hoque, check how to key of the session
    private String aliasKey = "";


    //TODO: Hoque, check start time of remote conneciton
    private long sessionBeginTime = 0;

	private boolean iscandidateFlow = false;

    //TODO: Hoque, check end time of remote conneciton
    private long sessionEndTime = 0;


    //TODO: Hoque, check received bytes remote conneciton
    private long rxBytes = 0;

    //TODO: Hoque, check sent bytes to remote conneciton
	...
	//TODO: Hoque, set and get the transport protocol
	public String getTransport(){return this.protocolType;}
	public void setTransport(String protocolType){this.protocolType = protocolType;}
	public void setOwnerApplicationName(String appName){this.appName = appName;}
	public String getOwnerApplicationName(){return this.appName;}
    public void setSessionKey(String key){this.aliasKey = key;}
    public String getSessionKey(){return this.aliasKey;}
    public void setFlowReceivedBytes(int bytes){this.rxBytes += bytes;}
    public long getFlowReceivedBytes(){return this.rxBytes;}
    public void setFLowUplinkBytes(int bytes){this.txBytes += bytes;}
    public long getFLowUplinkBytes(){return this.txBytes;}
    public void setFlowBeginTime(long time){this.sessionBeginTime = time;}
    public long getFlowBeginTime(){return this.sessionBeginTime;}
    public void setFlowEndTime(long time){ this.sessionEndTime = time;}
    public long getFlowDuration(){return (this.sessionEndTime-this.sessionEndTime);}


    public FlowMetaData getFlow(){return this.flow;}
    //public void updateFlowQueue(){
	//	VpnFlowCache.getQueueInstance().push(this.aliasKey,this.flow);}
	public boolean isCandidateFlow(){return this.iscandidateFlow;}
	public void setCandidateFlow(boolean state){this.iscandidateFlow = state;}
